...
if(isset($_GET["Id"]))
{
	...
	$sql="Update  tbleducationdetails set AdminAcceptFlag='$Flag'  where ID='$Id' ";
	  echo($sql);
...
$UserId=$_SESSION["UserId"];
//echo $UserId;
$sql="select * from  tbleducationdetails where (AdminAcceptFlag is null or AdminAcceptFlag=0) ";
...
{
	echo "<table style='border:solid 2px gray;padding:10px;'>
	...
	while($row=$Result->fetch_assoc())
	{
		echo " <tr style='border-bottom:solid 1px gray;padding:10px;line-height:25px;'> 
					...
					<td> <a href='ApproveCertificate.php?Id=".$row["Id"]."&Flag=1'>Accept</a> &nbsp;
					 <a href='ApproveCertificate.php?Id=".$row["Id"]."&Flag=2'>Declain</a></td>
