<?php
	...
	if(isset($_POST["Title"]))
	{
        ...
        if($Result!==false && $Result->num_rows>0)
        {
               ...
               $sql="update tbltestimonials  set Title='$Title',Description='$Description'  where UserId='$UserId'";
        }
        else 
        {
	    		$sql="Insert into tbltestimonials (Title,Description,UserId)values('$Title' ,'$Description','$UserId')";
        }	
	


			//$sql="Insert into tbltestimonials (Title,Description,UserId)values('$Title' ,'$Description','$UserId')";
		//$sql="update tbltestimonials  set Title='$Title',Description='$Description',UserId='$UserId'";
		//echo $sql;
...
<body id="body">
  ...
  <main id="main">
    ...
    ============================-->
    <form method="Post" action="TestimonialsPage.php"  enctype="multipart/form-data">
    <section id="about" class="wow fadeInUp">
      <div class="container">
      <div class="row">
          <div class="col-lg-12 about-img">
              <h2>Testimonials Page Entry</h2>
          </div>
