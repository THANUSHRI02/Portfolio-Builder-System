...
if(isset($_GET["Id"]))
{
	...
	$sql="Delete  from tblworkspage   where ID='$Id' ";
	  echo($sql);
...
if($Result!==false && $Result->num_rows>0)
{
	...
	while($row=$Result->fetch_assoc())
	{
		...
		<td> <a href='WorkPage.php?Id=".$row["Id"]."&Flag=Edit'>Edit</a> &nbsp;
					 <a href='WorkList.php?Id=".$row["Id"]."&Flag=Delete'>Delete</a></td>
