<?php
	...
	if(isset($_POST["Title"]))
	{
		...
		$target_dir = "uploads/";
		$uploadOk=1;
		$HomeImage= $target_dir . basename($_FILES["Uploadfile"]["name"]);
					             
			if (move_uploaded_file($_FILES["Uploadfile"]["tmp_name"], $HomeImage))
			{
        ...
        if($Result!==false && $Result->num_rows>0)
        {
               ...
               $sql="update tblhomepage  set Title='$Title',Description='$Description',HomeImage='$HomeImage'  where UserId='$UserId'";
        }
        else 
        {
	    		$sql="Insert into tblhomepage (Title,Description,UserId,HomeImage)values('$Title' ,'$Description','$UserId','$HomeImage')";
        }	
